...
interface CommentTargetAuthorNickName extends Pick<GetCommentsItemDto, 'parent' | 'depth'> {}
function CommentTargetAuthorNickName({ depth, parent }: CommentTargetAuthorNickName) {
  return (
